ECt = importdata('C:\Datas\MOSAIC\expression\chromium_data\clean_count_data\pdx471f_nufp10k.txt');
...
cell_groups_EC = importdata('C:\Datas\MOSAIC\expression\chromium_data\clean_count_data\pdx471f_nufp_clusters.txt');
...
c = importdata('C:\Datas\MOSAIC\expression\chromium_data\clean_count_data\pdx471f_nufp2k_modulescores.txt','%c',3573); 
...
D = pdist2(Epca,Epca);
save_spring_dir(EC,D,6,gene_list_EC,'../datasets/pdx471f_pool','cell_groupings',cell_groups_EC,'custom_colors',custom_colors_EC);
%save_spring_dir(EC,D,6,gene_list_EC,'../datasets/pdx471f_pool');