ECt = importdata('C:\Datas\Aynaud\P53_mut.txt');
EC = ECt.data';
...
cell_groups_EC = importdata('C:\Datas\Aynaud\P53_mut_groups.txt');
...
c = importdata('C:\Datas\Aynaud\P53_mut_scores.txt','%c',2476);
...
Epca = score(:,1:20);
D = pdist2(Epca,Epca);
%save_spring_dir(EC,D,5,gene_list_EC,'../datasets/P53mut','cell_groupings',cell_groups_EC);
save_spring_dir(EC,D,5,gene_list_EC,'../datasets/P53mut','cell_groupings',cell_groups_EC,'custom_colors',custom_colors_EC);
